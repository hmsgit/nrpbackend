...
# Generated 2017-10-27 17:22:08.769784 by PyXB version 1.2.4 using Python 2.7.12.final.0
# Namespace http://schemas.humanbrainproject.eu/SP10/2014/ExDConfig

# ./exp_conf_api_gen.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:e455c55bde4037492ee2ed5fe3b59ed8c44bb0d3
# Generated 2017-10-27 19:51:12.489816 by PyXB version 1.2.4 using Python 2.7.12.final.0
# Namespace http://schemas.humanbrainproject.eu/SP10/2014/ExDConfig
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6bc14c0c-bb3f-11e7-a008-4ccc6ab01b83')
...
class ThumbnailFile (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 18, 2)
...
class MaturityType (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 27, 2)
...
class ConfTypeEnumeration (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 87, 2)
...
class PhysicsEngine (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 198, 2)
...
class ConfType (pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 80, 2)
...
class RobotPose (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 38, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __x._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 42, 4)
    __x._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 42, 4)
    ...
    __y._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 47, 4)
    __y._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 47, 4)
    ...
    __z._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 52, 4)
    __z._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 52, 4)
    ...
    __ux._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 57, 4)
    __ux._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 57, 4)
    ...
    __uy._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 58, 4)
    __uy._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 58, 4)
    ...
    __uz._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 59, 4)
    __uz._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 59, 4)
    ...
    __theta._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 60, 4)
    __theta._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 60, 4)
...
class Position (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 97, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __x._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 101, 4)
    __x._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 101, 4)
    ...
    __y._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 106, 4)
    __y._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 106, 4)
    ...
    __z._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 111, 4)
    __z._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 111, 4)
...
class EnvironmentModel (pyxb.binding.basis.complexTypeDefinition):
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 149, 4)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 149, 4)
...
class VisualModel (pyxb.binding.basis.complexTypeDefinition):
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 164, 4)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 164, 4)
    ...
    __scale._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 165, 4)
    __scale._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 165, 4)
...
class BibiConf (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 169, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 173, 4)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 173, 4)
    ...
    __processes._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 178, 4)
    __processes._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 178, 4)
...
class RosLaunch (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 186, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 190, 4)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 190, 4)
...
class ExD_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 209, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element {http://schemas.humanbrainproject.eu/SP10/2014/ExDConfig}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpschemas_humanbrainproject_euSP102014ExDConfig_ExD__httpschemas_humanbrainproject_euSP102014ExDConfigname', False, pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 214, 6), )
...
class GzBridgeSettings (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 318, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class StateMachine (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 344, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __id._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 348, 4)
    __id._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 348, 4)
...
class SMACHStateMachine (StateMachine):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 355, 2)
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 361, 8)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 361, 8)
...
class SCXMLStateMachine (StateMachine):
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 379, 8)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 379, 8)
...
class ConfFile (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 64, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 68, 4)
    __src._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 68, 4)
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 73, 4)
    __type._UseLocation = pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 73, 4)
...
ExD = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExD'), ExD_, documentation='The root element of a experiment configuration model must be an ExD object.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 384, 2))
Namespace.addCategoryObject('elementBinding', ExD.name().localName(), ExD)



CameraPose._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cameraPosition'), Position, scope=CameraPose, documentation='The position of the camera', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 124, 6)))

CameraPose._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cameraLookAt'), Position, scope=CameraPose, documentation='The position to which the camera should look at', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 129, 6)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CameraPose._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cameraPosition')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 124, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CameraPose._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cameraLookAt')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 129, 6))
...
EnvironmentModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'robotPose'), RobotPose, scope=EnvironmentModel, documentation='The position of the robot', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 143, 6)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(EnvironmentModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'robotPose')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 143, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
VisualModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'visualPose'), RobotPose, scope=VisualModel, location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 162, 6)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(VisualModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'visualPose')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 162, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), pyxb.binding.datatypes.string, scope=ExD_, documentation='This element denotes the name of the experiment as it appears in the experiment list.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 214, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thumbnail'), ThumbnailFile, scope=ExD_, documentation='This element references a path to a thumbnail that is used to give the user a forecast to the experiment.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 219, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), pyxb.binding.datatypes.string, scope=ExD_, documentation='This description will appear in the experiment description and provide a short description explaining what the experiment is all about.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 224, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'timeout'), pyxb.binding.datatypes.double, scope=ExD_, documentation='The timeout of an experiment is the time an experiment is allowed to run by default, specified in seconds. If that time has elapsed, the users are asked whether they want to extend the runtime of the simulation. On the servers, this will only be allowed if the timeout fits within the cluster allocation.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 229, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'configuration'), ConfFile, scope=ExD_, documentation='An experiment may have multiple configuration entries. Despite configuration entries can be specified in anywhere in the ExD element, they must appear together.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 234, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'maturity'), MaturityType, scope=ExD_, documentation='The maturity of an experiment determines whether it is shown by default to the user or only browsable in dev mode.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 239, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'environmentModel'), EnvironmentModel, scope=ExD_, documentation='The environment model of an experiment specifies the used world file for a simulation and the pose where the robot should be spawned.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 244, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'visualModel'), VisualModel, scope=ExD_, documentation='With the visual model, an experiment can specify an alternatively used model for the frontend visualization. This is helpful in case the robot model used in gazebo is very detailed and thus hard to visualize on the client. On the server, there may be more resources available to simulate more complex models.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 249, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bibiConf'), BibiConf, scope=ExD_, documentation='The bibiConf element of an experiment configuration specifies the ', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 254, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'experimentControl'), ExperimentControl, scope=ExD_, documentation='The experiment control lists all state machines that control the experiment.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 259, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'experimentEvaluation'), ExperimentControl, scope=ExD_, documentation='The experiment evaluation element lists all state machines that evaluate the success of a simulated experiment.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 268, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cameraPose'), CameraPose, scope=ExD_, documentation='The camera pose specifies the initial position of the camera when a simulation is started.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 277, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rosLaunch'), RosLaunch, scope=ExD_, documentation='The roslaunch element species the path to a ROSLaunch file that is executed when the experiment is simulated. If no file is specified, no ROSLaunch file is executed at the beginning of an experiment.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 282, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rngSeed'), pyxb.binding.datatypes.positiveInteger, scope=ExD_, documentation='If specified, this element specifies the random number generator seed. If this field is left blank, a seed is generated and therefore, the simulation is not 100% deterministic. If a seed is specified here, this seed is used for the robot and neural simulation, making the simulation much more deterministic.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 287, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'physicsEngine'), PhysicsEngine, scope=ExD_, documentation='If specified, this element denotes the physics simulator that should be used. We currently support either ODE or OpenSim.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 292, 6)))

ExD_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gzbridgesettings'), GzBridgeSettings, scope=ExD_, documentation='Settings for the relay of the component relaying information from the simulation backend to the visualization client.', location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 297, 6)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 229, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 234, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 239, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 249, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 259, 6))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 268, 6))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 277, 6))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 282, 6))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 287, 6))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 292, 6))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 297, 6))
    counters.add(cc_10)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 214, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thumbnail')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 219, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 224, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'timeout')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 229, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'configuration')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 234, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'maturity')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 239, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'environmentModel')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 244, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'visualModel')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 249, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bibiConf')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 254, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'experimentControl')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 259, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'experimentEvaluation')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 268, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cameraPose')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 277, 6))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rosLaunch')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 282, 6))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rngSeed')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 287, 6))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'physicsEngine')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 292, 6))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(ExD_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gzbridgesettings')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 297, 6))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(ExperimentControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stateMachine')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 310, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
def _BuildAutomaton_5 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 320, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 327, 12))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 334, 12))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(GzBridgeSettings._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pose_update_delta_translation')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 320, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(GzBridgeSettings._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pose_update_delta_rotation')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 327, 12))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(GzBridgeSettings._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pose_update_early_threshold')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 334, 12))
...
SCXMLStateMachine._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_sc, 'scxml'), _ImportedBinding__sc.scxml_scxml_type, scope=SCXMLStateMachine, location=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/hbp-scxml/hbp-scxml-module-core.xsd', 86, 1)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 377, 10))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SCXMLStateMachine._UseForTag(pyxb.namespace.ExpandedName(_Namespace_sc, 'scxml')), pyxb.utils.utility.Location('/mnt/work/NRP/src/Experiments/ExDConfFile.xsd', 377, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
