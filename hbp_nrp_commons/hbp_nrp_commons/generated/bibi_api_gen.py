...
# Generated 2017-09-08 16:57:02.196816 by PyXB version 1.2.4 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    'urn:uuid:f89a11e2-94a5-11e7-9aac-5cc5d4143bf0')
...
class TimeStep(pyxb.binding.datatypes.positiveInteger):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 30, 4)
    _Documentation = None


TimeStep._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=TimeStep,
...
class SDFFilename(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 50, 4)
    _Documentation = None
...
class H5Filename(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 56, 4)
    _Documentation = None
...
class PythonFilename(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 62, 4)
    _Documentation = None
...
class ScriptFilename(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 68, 4)
    _Documentation = None
...
class ConfTypeEnumeration(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 83, 4)
    _Documentation = None
...
ConfTypeEnumeration.retina = ConfTypeEnumeration._CF_enumeration.addEnumeration(
    unicode_value='retina', tag='retina')
ConfTypeEnumeration.brainvisualizer = ConfTypeEnumeration._CF_enumeration.addEnumeration(
...
class NeuronTarget(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 157, 4)
    _Documentation = None
...
class TemplatePattern(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 326, 4)
    _Documentation = None
...
class DeviceType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 362, 4)
    _Documentation = None
...
class RobotTopicAddress(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 385, 4)
    _Documentation = None
...
class BrainFilename(pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 46, 4)
    _Documentation = None
...
class ConfType(pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 79, 4)
    _Documentation = None
...
class BIBIConfiguration(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 9, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element {http://schemas.humanbrainproject.eu/SP10/2014/BIBI}timestep uses Python identifier timestep
    __timestep = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, 'timestep'), 'timestep',
        '__httpschemas_humanbrainproject_euSP102014BIBI_BIBIConfiguration_httpschemas_humanbrainproject_euSP102014BIBItimestep',
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 11,
                                    12), )
    ...
    __brainModel = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 12,
                                    12), )
    ...
    __bodyModel = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 13,
                                    12), )
    ...
    __extRobotController = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 14,
                                    12), )
    ...
    __configuration = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 16,
                                    12), )
    ...
    __connectors = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 19,
                                    12), )
    ...
    __synapseDynamics = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 22,
                                    12), )
    ...
    __transferFunction = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 25,
                                    12), )
...
class BrainModel(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 36, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __file = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'file'),
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 38, 12), )
    ...
    __populations = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 40,
                                    12), )
...
class TransferFunction(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 91, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _ElementMap.update({
...
class NeuronConnector(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 164, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __weights._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 165, 8)
    ...
    __delays._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 166, 8)
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 167, 8)
...
class NeuronConnectorRef(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 170, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __ref._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 173, 16)
...
class SynapseDynamics(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 198, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               unicode_default='default')
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 199, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 199, 8)
...
class SynapseDynamicsRef(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 202, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'ref'), 'ref',
                                              ...
                                              pyxb.binding.datatypes.string, required=True)
    __ref._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 205, 16)
    __ref._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 205, 16)
...
class NeuronGroupSelector(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 256, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _ElementMap.update({
...
class NeuronSelector(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 280, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __population._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 281, 8)
...
class NeuronSelectorTemplate(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 332, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _ElementMap.update({
...
class FlowExpression(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 391, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _ElementMap.update({
...
class Argument(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 461, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __value = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 463,
                                    12), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 465, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 465, 8)
...
class Local(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 468, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __body = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'body'),
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 470, 12), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 472, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 472, 8)
...
class PythonTransferFunction(TransferFunction):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 93, 4)
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 101, 16)
...
class BIBITransferFunction(TransferFunction):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 107, 4)
    _ElementMap = TransferFunction._ElementMap.copy()
    _AttributeMap = TransferFunction._AttributeMap.copy()
    # Base type is TransferFunction
    ...
    __local = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 111,
                                    20), )
    ...
    __device = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 113,
                                    24), )
    ...
    __deviceGroup = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 114,
                                    24), )
    ...
    __topic = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 116,
                                    20), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 118, 16)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 118, 16)
...
class OneToOneConnector(NeuronConnector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 178, 4)
...
class AllToAllConnector(NeuronConnector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 184, 4)
    _ElementMap = NeuronConnector._ElementMap.copy()
    _AttributeMap = NeuronConnector._AttributeMap.copy()
    # Base type is NeuronConnector
...
class FixedNumberPreConnector(NeuronConnector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 190, 4)
    _ElementMap = NeuronConnector._ElementMap.copy()
    _AttributeMap = NeuronConnector._AttributeMap.copy()
    # Base type is NeuronConnector
    ...
    __count._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 193, 16)
...
class TsodyksMarkramMechanism(SynapseDynamics):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 210, 4)
    ...
    __u._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 213, 16)
    ...
    __tau_rec._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 214, 16)
    ...
    __tau_facil._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 215, 16)
...
class DeviceChannel(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 220, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __neurons = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 222,
                                    12), )
    ...
    __connector = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 224,
                                    16), )
    ...
    __connectorRef = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 225,
                                    16), )
    ...
    __synapseDynamics = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 228,
                                    16), )
    ...
    __synapseDynamicsRef = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 229,
                                    16), )
    ...
    __target = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 231,
                                    12), )
    ...
    __body = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'body'),
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 232, 12), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 234, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 234, 8)
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 235, 8)
...
class DeviceGroupChannel(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 238, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __neurons = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 240,
                                    12), )
    ...
    __connector = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 242,
                                    16), )
    ...
    __connectorRef = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 243,
                                    16), )
    ...
    __synapseDynamics = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 246,
                                    16), )
    ...
    __synapseDynamicsRef = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 247,
                                    16), )
    ...
    __target = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 249,
                                    12), )
    ...
    __body = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'body'),
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 250, 12), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 252, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 252, 8)
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'type'), 'type',
                                               ...
                                               DeviceType, required=True)
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 253, 8)
    __type._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 253, 8)
...
class ChainSelector(NeuronGroupSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 258, 4)
    ...
    __neurons = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 262,
                                    20), )
    ...
    __connectors = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 263,
                                    20), )
...
class MapSelector(NeuronGroupSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 269, 4)
    _ElementMap = NeuronGroupSelector._ElementMap.copy()
    _AttributeMap = NeuronGroupSelector._AttributeMap.copy()
    # Base type is NeuronGroupSelector
    ...
    __source = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 273,
                                    20), )
    ...
    __pattern = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 274,
                                    20), )
...
class Index(NeuronSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 284, 4)
    ...
    __index._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 287, 16)
...
class MultiNeuronSelector(NeuronSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 292, 4)
    _ElementMap = NeuronSelector._ElementMap.copy()
    _AttributeMap = NeuronSelector._AttributeMap.copy()
    # Base type is NeuronSelector
...
class IndexTemplate(NeuronSelectorTemplate):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 334, 4)
    ...
    __index._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 337, 16)
    __index._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 337, 16)
...
class RangeTemplate(NeuronSelectorTemplate):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 342, 4)
    _ElementMap = NeuronSelectorTemplate._ElementMap.copy()
    _AttributeMap = NeuronSelectorTemplate._AttributeMap.copy()
    # Base type is NeuronSelectorTemplate
    ...
    __from._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 345, 16)
    ...
    __to._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 346, 16)
    ...
    __step._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 347, 16)
...
class ListTemplate(NeuronSelectorTemplate):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 352, 4)
    _ElementMap = NeuronSelectorTemplate._ElementMap.copy()
    _AttributeMap = NeuronSelectorTemplate._AttributeMap.copy()
    # Base type is NeuronSelectorTemplate
    ...
    __element = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 356,
                                    20), )
...
class TopicChannel(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 376, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __body = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'body'),
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 378, 12), )
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 380, 8)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 380, 8)
    ...
    __topic = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'topic'), 'topic',
                                                ...
                                                RobotTopicAddress, required=True)
    __topic._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 381, 8)
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'type'), 'type',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 382, 8)
    __type._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 382, 8)
...
class Scale(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 393, 4)
    ...
    __inner = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 397,
                                    20), )
    ...
    __factor._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 399, 16)
...
class Call(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 404, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    ...
    __argument = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 408,
                                    20), )
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'type'), 'type',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 410, 16)
    __type._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 410, 16)
...
class Operator(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 415, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    ...
    __operand = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 419,
                                    20), )
...
class SimulationStep(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 475, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    _ElementMap.update({
...
class ArgumentReference(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 481, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 484, 16)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 484, 16)
    ...
    __property._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 485, 16)
...
class Constant(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 490, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    ...
    __value._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 493, 16)
...
class ConstantString(FlowExpression):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 498, 4)
    _ElementMap = FlowExpression._ElementMap.copy()
    _AttributeMap = FlowExpression._AttributeMap.copy()
    # Base type is FlowExpression
    ...
    __value = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'value'),
                                                ...
                                                pyxb.binding.datatypes.string, required=True)
    __value._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 501, 16)
    __value._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 501, 16)
...
class ConfFile(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 74, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    # Attribute src uses Python identifier src
    __src = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'src'), 'src',
                                              '__httpschemas_humanbrainproject_euSP102014BIBI_ConfFile_src',
                                              pyxb.binding.datatypes.string, required=True)
    __src._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 75, 8)
    __src._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 75, 8)
    ...
    # Attribute type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'type'), 'type',
                                               '__httpschemas_humanbrainproject_euSP102014BIBI_ConfFile_type',
                                               ConfType, required=True)
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 76, 8)
    __type._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 76, 8)
...
class Robot2Neuron(BIBITransferFunction):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 123, 4)
    ...
    __returnValue = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 127,
                                    20), )
...
class Neuron2Monitor(BIBITransferFunction):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 133, 4)
    _ElementMap = BIBITransferFunction._ElementMap.copy()
    _AttributeMap = BIBITransferFunction._AttributeMap.copy()
    # Base type is BIBITransferFunction
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name',
                                               ...
                                               pyxb.binding.datatypes.string, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 142, 16)
    __name._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 142, 16)
...
class Neuron2Robot(BIBITransferFunction):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 147, 4)
    _ElementMap = BIBITransferFunction._ElementMap.copy()
    _AttributeMap = BIBITransferFunction._AttributeMap.copy()
    # Base type is BIBITransferFunction
    ...
    __returnValue = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 151,
                                    20), )
...
class Range(MultiNeuronSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 298, 4)
    ...
    __from = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'from'), 'from_',
                                               ...
                                               required=True)
    __from._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 301, 16)
    __from._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 301, 16)
    ...
    __to = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'to'), 'to',
                                             ...
                                             required=True)
    __to._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 302, 16)
    __to._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 302, 16)
    ...
    __step = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'step'), 'step',
                                               ...
                                               pyxb.binding.datatypes.positiveInteger)
    __step._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 303, 16)
    __step._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 303, 16)
...
class List(MultiNeuronSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 308, 4)
    _ElementMap = MultiNeuronSelector._ElementMap.copy()
    _AttributeMap = MultiNeuronSelector._AttributeMap.copy()
    # Base type is MultiNeuronSelector
    ...
    __element = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 312,
                                    20), )
...
class Population(MultiNeuronSelector):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 318, 4)
    _ElementMap = MultiNeuronSelector._ElementMap.copy()
    _AttributeMap = MultiNeuronSelector._AttributeMap.copy()
    # Base type is MultiNeuronSelector
    ...
    __count = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'count'), 'count',
                                                ...
                                                required=True)
    __count._DeclarationLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 321, 16)
    __count._UseLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 321, 16)
...
class Add(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 425, 4)
...
class Subtract(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 431, 4)
    _ElementMap = Operator._ElementMap.copy()
    _AttributeMap = Operator._AttributeMap.copy()
    # Base type is Operator
...
class Multiply(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 437, 4)
    _ElementMap = Operator._ElementMap.copy()
    _AttributeMap = Operator._AttributeMap.copy()
    # Base type is Operator
...
class Divide(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 443, 4)
    _ElementMap = Operator._ElementMap.copy()
    _AttributeMap = Operator._AttributeMap.copy()
    # Base type is Operator
...
class Min(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 449, 4)
    _ElementMap = Operator._ElementMap.copy()
    _AttributeMap = Operator._AttributeMap.copy()
    # Base type is Operator
...
class Max(Operator):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 455, 4)
    _ElementMap = Operator._ElementMap.copy()
    _AttributeMap = Operator._AttributeMap.copy()
    # Base type is Operator
...
bibi = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bibi'), BIBIConfiguration,
                                  location=pyxb.utils.utility.Location(
                                      '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 8,
                                      4))
Namespace.addCategoryObject('elementBinding', bibi.name().localName(), bibi)

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'timestep'), TimeStep,
                               scope=BIBIConfiguration, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 11, 12)))

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'brainModel'), BrainModel,
                               scope=BIBIConfiguration, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 12, 12)))

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bodyModel'), SDFFilename,
                               scope=BIBIConfiguration, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 13, 12)))

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extRobotController'),
                               ScriptFilename, scope=BIBIConfiguration,
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 14,
                                   12)))

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'configuration'), ConfFile,
                               scope=BIBIConfiguration, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 16, 12)))

BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'connectors'),
                               NeuronConnector, scope=BIBIConfiguration,
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 19,
                                   12)))
...
BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'synapseDynamics'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 22,
                                   12)))
...
BIBIConfiguration._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'transferFunction'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 25,
                                   12)))
...
def _BuildAutomaton_():
    ...
    symbol = pyxb.binding.content.ElementUse(
        BIBIConfiguration._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'timestep')),
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 11,
                                    12))
...
def _BuildAutomaton_4():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 14, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
def _BuildAutomaton_6():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 19, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
def _BuildAutomaton_7():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 22, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
def _BuildAutomaton_8():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 25, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
def _BuildAutomaton():
    ...
    final_update = set()
    symbol = pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd',
                                         10, 8)
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
...
BrainModel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'file'), BrainFilename,
...
BrainModel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'populations'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 40,
                                   12)))
...
def _BuildAutomaton_10():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 38,
                                    12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_0)
...
def _BuildAutomaton_11():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 40, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
BrainModel._Automaton = _BuildAutomaton_9()
...
Argument._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), FlowExpression,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 463, 12)))
...
Argument._Automaton = _BuildAutomaton_12()
...
def _BuildAutomaton_13():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 470,
                                    12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_0)
...
Local._Automaton = _BuildAutomaton_13()
...
def _BuildAutomaton_14():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 97, 20))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 97,
                                    20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_0)
...
PythonTransferFunction._Automaton = _BuildAutomaton_14()
...
BIBITransferFunction._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'local'), Local,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 111, 20)))

BIBITransferFunction._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'device'), DeviceChannel,
                               scope=BIBITransferFunction, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 113, 24)))
...
BIBITransferFunction._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'deviceGroup'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 114,
                                   24)))

BIBITransferFunction._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'topic'), TopicChannel,
                               scope=BIBITransferFunction, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 116, 20)))
...
def _BuildAutomaton_15():
    ...
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 112, 20))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 116, 20))
    counters.add(cc_2)
...
BIBITransferFunction._Automaton = _BuildAutomaton_15()
...
DeviceChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'synapseDynamics'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 228,
                                   16)))
...
DeviceChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'synapseDynamicsRef'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 229,
                                   16)))

DeviceChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'target'), NeuronTarget,
                               scope=DeviceChannel, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 231, 12)))
...
def _BuildAutomaton_16():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 223, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 227, 12))
    counters.add(cc_1)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 232,
                                    12))
...
DeviceChannel._Automaton = _BuildAutomaton_16()
...
DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'neurons'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 240,
                                   12)))

DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'connector'), NeuronConnector,
                               scope=DeviceGroupChannel, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 242, 16)))

DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'connectorRef'),
                               NeuronConnectorRef, scope=DeviceGroupChannel,
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 243,
                                   16)))
...
DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'synapseDynamics'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 246,
                                   16)))
...
DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'synapseDynamicsRef'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 247,
                                   16)))

DeviceGroupChannel._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'target'), NeuronTarget,
                               scope=DeviceGroupChannel, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 249, 12)))
...
def _BuildAutomaton_17():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 241, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 245, 12))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 249, 12))
    counters.add(cc_2)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 250,
                                    12))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_6)
...
DeviceGroupChannel._Automaton = _BuildAutomaton_17()

ChainSelector._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'neurons'), NeuronSelector,
                               scope=ChainSelector, location=pyxb.utils.utility.Location(
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 262, 20)))

ChainSelector._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'connectors'),
                               NeuronGroupSelector, scope=ChainSelector,
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 263,
                                   20)))
...
def _BuildAutomaton_18():
    ...
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 263, 20))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
ChainSelector._Automaton = _BuildAutomaton_18()
...
MapSelector._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'source'),
                                                   ...
                                                   location=pyxb.utils.utility.Location(
                                                       '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd',
                                                       273, 20)))
...
MapSelector._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pattern'),
                               ...
                               location=pyxb.utils.utility.Location(
                                   '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 274,
                                   20)))
...
MapSelector._Automaton = _BuildAutomaton_19()
...
ListTemplate._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'element'), TemplatePattern,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 356, 20)))
...
ListTemplate._Automaton = _BuildAutomaton_20()
...
def _BuildAutomaton_21():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 378,
                                    12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_0)
...
TopicChannel._Automaton = _BuildAutomaton_21()
...
Scale._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inner'), FlowExpression,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 397, 20)))
...
Scale._Automaton = _BuildAutomaton_22()
...
Call._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'argument'), Argument,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 408, 20)))
...
Call._Automaton = _BuildAutomaton_23()
...
Operator._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operand'), FlowExpression,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 419, 20)))
...
Operator._Automaton = _BuildAutomaton_24()
...
Robot2Neuron._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'returnValue'), DeviceChannel,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 127, 20)))
...
Robot2Neuron._Automaton = _BuildAutomaton_25()
...
def _BuildAutomaton_26():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 137, 20))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 138, 20))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 137,
                                    20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 139,
                                    24))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update,
                     is_unordered_catenation=False)
    states.append(st_1)
...
Neuron2Monitor._Automaton = _BuildAutomaton_26()
...
Neuron2Robot._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'returnValue'), TopicChannel,
            ...
            '/mnt/d/Projekte/HBP/Experiments/bibi_configuration.xsd', 151, 20)))
...
Neuron2Robot._Automaton = _BuildAutomaton_27()
...
List._Automaton = _BuildAutomaton_28()
...
Add._Automaton = _BuildAutomaton_29()
...
Subtract._Automaton = _BuildAutomaton_30()
...
Multiply._Automaton = _BuildAutomaton_31()
...
Divide._Automaton = _BuildAutomaton_32()
...
Min._Automaton = _BuildAutomaton_33()
...
Max._Automaton = _BuildAutomaton_34()
