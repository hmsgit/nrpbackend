...
release = hbp_nrp_commons.__version__
...
htmlhelp_basename = 'hbp_nrp_commons_doc'
...
latex_documents = [
  ('index', 'hbp_nrp_commons.tex', u'NRP Backend Commons Documentation',
   u'hinkel', 'manual'),
]
