...
release = hbp_nrp_backend.__version__
...
latex_documents = [
  ('index', 'hbp_nrp_backend.tex', u'Experiment Backend Documentation',
...
man_pages = [
    ('index', 'hbp_nrp_backend', u'Experiment Backend Documentation',
     [u'hinkel'], 1)
]
...
texinfo_documents = [
  ('index', 'hbp_nrp_backend', u'Experiment Backend Documentation',
   u'Human Brain Project', 'hbp_nrp_backend', 'The integration component to connect the neuronal simulator and the world simulator',
   'Miscellaneous'),
]
