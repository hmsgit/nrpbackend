...
class TestROSCLESimulationFactoryClient(unittest.TestCase):
    ...
    def test_create_new_simulation(self, mock_service_proxy):
        ...
        self.assertIsNone(roscle.create_new_simulation(1, 2, 3, 4, 5, 6, 7))
        service_proxy.assert_once_called_with(1, 2, 3, 4, 5, 6, 7)
        service_proxy.side_effect = Exception
        self.assertRaises(Exception, roscle.create_new_simulation, 1, 2, 3, 4, 5, 6, 7)
