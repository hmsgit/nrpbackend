...
project = u'hbp_nrp_cleserver'
copyright = u'2015 Human Brain Project. All rights reserved.'
...
release = hbp_nrp_cleserver.__version__
...
latex_documents = [
  ('index', 'hbp_nrp_cleserver.tex', u'CLE Server Documentation',
   u'hinkel', 'manual'),
]
...
man_pages = [
    ('index', 'hbp_nrp_cleserver', u'CLE Server Documentation',
     [u'hinkel'], 1)
]
...
texinfo_documents = [
  ('index', 'hbp_nrp_cleserver', u'CLE Server Documentation',
   u'hinkel', 'hbp_nrp_cleserver', 'Project to start the CLE in a separate process',
   'Neurorobotics'),
]
