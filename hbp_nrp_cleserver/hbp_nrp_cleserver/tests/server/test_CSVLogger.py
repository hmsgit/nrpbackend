...
class TestSimulationCSVLogger(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_assembly = MagicMock()
        self.mock_assembly.sim_config.token = 'token'
        self.mock_assembly.sim_config.experiment_id = 'expId'
    ...
    def test_CSV_logger_init(self, mock_get_date_and_time_string):
        ...
        csv_logger = CSVLogger(self.mock_assembly, 5, 'testFolder')
        ...
        self.assertEqual(csv_logger._assembly.sim_config.token, 'token')
        self.assertEqual(csv_logger._assembly.sim_config.experiment_id, 'expId')
    ...
    def test_CSV_logger_lifecycle(self, mock_get_date_and_time_string, mock_killable):
        ...
        to_be_killed_thread = csv_logger._log_csv_thread
        csv_logger.shutdown()
        self.assertTrue(to_be_killed_thread.join.called)
